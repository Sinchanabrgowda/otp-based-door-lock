...
SoftwareSerial sim800l(2, 3); // Gsm Tx-> Arduino Pin 2  GSM Rx -> Arduino Pin 3
int irsensor =A0;
int otp;
String otpstring ="";
int i=0;
...
void SendSMS()
{
  ...
  delay(500);
  sim800l.print("AT+CMGS=\"+919790906809\"\r");  //Your phone number don't forget to include your country code, example +212123456789"
  delay(500);
  sim800l.print("Your OTP is "+otpstring+"  to unlock door");       //This is the text to send to the phone number, don't make it too long or you have to modify the SoftwareSerial buffer
  delay(500);
